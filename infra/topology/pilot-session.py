...
PROFILE_POLICIES[LAYOUT_PROFILE] = {
    **PROFILE_POLICIES[PAIRED_PROFILES[0]],
    # Qualification first: four starts, 16 requests, no long timing block.
    "cleanup_start_seconds": 55 * 60,
    "deletion_target_seconds": 75 * 60,
    "hourly_rate_usd_pretax": Decimal("20.05"),
    "attempt_admission_usd_pretax": Decimal("27"),
...
PROFILE_POLICIES[ROUTER_SESSION_PROFILE] = {
    **PROFILE_POLICIES[LAYOUT_PROFILE],
    ...
    'attempt_admission_usd_pretax': Decimal('74'), 'staged_cost_accounting': True,
}
